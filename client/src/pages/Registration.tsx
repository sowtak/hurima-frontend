...
import logo from "../images/icons/fleabay-logo-purple.svg";
...
export const Registration: FC = () => {
  ...
  return (
    <>
      ...
      {failure ? (
        <Alert severity={"error"}>Failed to send verification code</Alert>
      ) : null}
      ...
      <FormContainer sx={{ paddingTop: "24px", paddingBottom: "12px" }}>
        ...
        >
          Please enter your registration info here and receive account
          verification code.
        </Typography>
